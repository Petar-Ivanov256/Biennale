...
class CountriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::insert("INSERT INTO `countries` (`id`, `created_at`, `updated_at`, `title`, `title_en`) VALUES
			...
			(29, NULL, NULL, 'Cabo Verde', 'Cabo Verde'),
			...
			(107, NULL, NULL, 'Marshall Islands', 'Marshall Islands'),
			...
			(183, NULL, NULL, 'Великобритания на Великобритания и Северна Ирландия', 'United Kingdom of Great Britain and Northern Ireland'),
