		...
		<form class="form-horizontal" method="POST" enctype="multipart/form-data">
		  ...
		  <fieldset>
		    ...
		    <div class="form-group">
		      ...
		      <div class="col-lg-6">
		        <input id="male" type="radio" name="gender" value="0" {{ $author->gender == 0 ? "checked" : "" }}><label for="male">Мъж</label>
		        <input id="female" type="radio" name="gender" value="1" {{ $author->gender == 1 ? "checked" : "" }}><label for="female">Жена</label>
