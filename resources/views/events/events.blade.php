    ...
    <div class="container" id="top">
        <div class="row">
                ...
                <div>
                    <div>
                        <ul class="events-menu">
                            ...
                            <li><a href="#"
                                   onclick="getCategory('Exhibition', 'Изложби')">{{ trans('events.events_menu_exhibitions') }}</a>
                            </li>
                            <li><a href="#"
                                   onclick="getCategory('Lecture','Лекции')">{{ trans('events.events_menu_lectures') }}</a>
                            </li>
                            <li><a href="#" onclick="getCategory('Workshop','Творчески работилници')"
                                   data-toggle="collapse">{{ trans('events.events_menu_workshops') }}</a></li>
                            <li><a href="#"
                                   onclick="getCategory('Contest','Конкурси')">{{ trans('events.events_menu_competitions') }}</a>
                            </li>
                            <li><a href="#"
                                   onclick="getCategory('Campaign','Кампании')">{{ trans('events.events_menu_campaigns') }}</a>
                            </li>
            ...
            <div class="col-md-11 programa" id="event-back">
                <div class="events-p"><p id="show_cat">{{ trans('events.all') }}<p></div>
                <br>
                <div class="filter-events">
                    @foreach($events as $event)
                        @if (LaravelLocalization::getCurrentLocale() == 'en')
                            <div class="col-md-4 {{$event->category->title_en}} all"
                                 onclick="getDetails({{ $event->id }}, '{{LaravelLocalization::getCurrentLocale()}}')">
                                ...
                                <a href="#details" class="abackcolor">
                                    ...
                                    <br>
                                    <span class="ptagleft" id="left-aligndate"> {{date('d.m', strtotime($event->start))}}
                                        -{{date('d.m', strtotime($event->end))}}</span>
                                    <span class="ptagleft" id="right-alignhour">{{date('H:i', strtotime($event->start))}}
                                        -{{date('H:i', strtotime($event->end))}}</span>
            ...
            <div class="col-md-5 programadetails" id="details">
                ...
                <div class="gallery-container event_program_details" id="gallery-container">
                    <a class="gallery" id="img-ref" href="">
                        <img src="" id="details-img">
                        {!! HTML::image('img/spinningwheel.gif', 'loading gif', array('id' => 'loading-gif')) !!}
                    </a>
                ...
                <a href="#top" class="back-to-top"><span class="ptagleftdetailss"></span><span
                            class="ptagleftdetailss">{{ trans('events.back_btn') }}</span></a>
            </div>
        </div>
    </div>
