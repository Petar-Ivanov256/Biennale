...
<div class="form-group">
    ...
    <div class="col-sm-10">
        ...
        <p class="help-block">title of the news</p>
    </div>
</div><div class="form-group">
    {!! Form::label('content', 'content', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('content', old('content',$news->content), array('class'=>'form-control')) !!}
        <p class="help-block">content of the news</p>
    </div>
</div><div class="form-group">
    ...
    <div class="col-sm-10">
        ...
        <p class="help-block">photo of the news</p>
    </div>
</div>
