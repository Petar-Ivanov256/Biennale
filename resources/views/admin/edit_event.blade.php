        ...
        <form class="form-horizontal"  action="{{ URL::to('/admin/editEvent') }}" method="POST" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <input type="text" class="form-control" id="artist" name="artist" placeholder="Артист" value="{{ $event->artist }}" autofocus>
                    </div>
                </div>
                <div class="form-group">
                    <label for="place" class="col-lg-2 control-label">Вход</label>
                    <div class="col-lg-6">
                        <input type="text" class="form-control" id="entrance" name="entrance" placeholder="Вход" value="{{ $event->entrance }}" autofocus>
                    </div>
                </div>
                <div class="form-group">
